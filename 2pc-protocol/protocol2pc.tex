...
\todo[inline]{this protocol, pulled from the code, does not include any of Sender's inputs. Seems that in the last step, $Y_{0}$ and $Y_{1}$ should not be chosen randomly but actually set equal to $K_{0}$ and $K_{1}$, as has been left in the comments. }
